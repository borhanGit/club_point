                    ...
                    <form action="{{ route('payment.checkout') }}" class="form-default" role="form" method="POST"
                        ...
                        <div class="card rounded border-0 shadow-sm">
                            ...
                            <div class="card-body text-center">
                                                    ...
                                                    <div class="col-6 col-md-4">
                                                        <label class="aiz-megabox d-block mb-3">
                                                            <input value="mpesa" class="online_payment" type="radio"
                                                                name="payment_option" checked>
                                                            <span class="d-block aiz-megabox-elem p-3">
                                                                <img src="{{ asset('assets/img/cards/mpesa.png') }}"
                                                                    class="img-fluid mb-2">
                                                                <span class="d-block text-center">
                                                                    <span
                                ...
                                @php
                                    $wallets = \App\Models\ConvertWallet::where('user_id', Auth::user()->id)->where('status',0)->orWhere('status',2)->orWhere('product_id',null)->sum('money');
                                @endphp
                                @if (Auth::check())
