...
// WALLET SYSTEM
Route::get('/admin/wallet',[WalletController::class,'wallet_dashboard'])->name('admin.wallet')->middleware(['auth','admin']);
Route::get('/admin/wallet/activation',[WalletController::class,'wallet_activation'])->name('walletActivation')->middleware(['auth','admin']);
Route::get('/admin/wallet/deactivation',[WalletController::class,'wallet_dactivation'])->name('walletDeactivation')->middleware(['auth','admin']);
Route::get('/admin/club/point-system',[WalletController::class,'club_system'])->name('admin.club_system')->middleware(['auth','admin']);
Route::post('/admin/club/point-system/store',[WalletController::class,'point_store'])->name('club_point_system.store')->middleware(['auth','admin']);
Route::post('/admin/club/point-wallet/store',[WalletController::class,'point_convert_wallet'])->name('point_convert_wallet.store')->middleware(['auth','admin']);
