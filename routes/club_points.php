...
Route::group(['middleware' => ['user', 'verified']], function(){
    Route::get('earning-points',[WalletController::class,'userpoint_index'])->name('earnng_point_for_user');
    Route::get('convert-point-wallet/{points}/{product_id}/{orderDId}',[WalletController::class,'convert_point_into_wallet'])->name('point_convert_wallet');
    // Route::controller(ClubPointController::class)->group(function () {
